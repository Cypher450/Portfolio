    ...
    <div name="Contact" className='w-full h-screen bg-gradient-to-b from-black to-gray-800 p-4 text-white'>
        <div className='flex flex-col p4 justify-center max-w-screen-lg mx-auto h-full'>
            <div className='pb-8'>
                ...
                <p className='py-6'>Submit the form belw to get in touch with me</p>
            </div>

            <div className='flex justify-center items-center'>
                <form action="https://getform.io/f/1247f000-13b5-48a3-ab1f-c99b0592a888" method='post' className='flex flex-col w-full md:w-1/2'>
