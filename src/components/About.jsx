...
const About = () => {
    return (
        <div name="about" className='flex items-center justify-center w-full h-screen bg-gradient-to-b from-gray-800 to-black text-white'>
